...
class Sample(Base):
    ...
    biological_sample_id = Column(String(100), nullable=False, index=True)  # e.g., "P5_F10"
    
    # Experimental Metadata
    treatment = Column(String(50), nullable=False, index=True)  # e.g., "CD81", "ISO", "Control"
...
class FCSResult(Base):
    ...
    # File Reference
    parquet_file_path = Column(Text, nullable=False)
